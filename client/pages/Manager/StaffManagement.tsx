        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-slate-50 border-b border-slate-100 text-slate-500 text-[10px] font-black uppercase tracking-widest">
              <tr>
                <th className="px-4 md:px-8 py-4 md:py-6">Nhân viên</th>
                <th className="px-4 md:px-8 py-4 md:py-6">Vai trò</th>
                <th className="px-4 md:px-8 py-4 md:py-6">Trust Score</th>
                <th className="px-4 md:px-8 py-4 md:py-6">Thiết bị</th>
            ...
            <tbody className="divide-y divide-slate-50">
              {loading ? (
                <tr>
                  <td colSpan={6} className="px-4 md:px-8 py-12 text-center text-slate-400">
                    Đang tải...
                  </td>
                </tr>
